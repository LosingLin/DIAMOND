...
bool HelloWorld::init()
{
    ...
    pCloseItem1->setPosition( ccp(CCDirector::sharedDirector()->getWinSize().width/2, 200) );
    pCloseItem1->setScale(1.5);
...
void HelloWorld::menuCloseCallback1(CCObject* pSender)
{
    ...
    //    exit(0);
    //#endif
    CCDirector::sharedDirector()->replaceScene(GameLayer1::scene());
}
